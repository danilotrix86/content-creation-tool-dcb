      ...
      const article = await runPhasedGeneration(
        {
          ...
          casino_bonus_page_text: data.casino_bonus_page_text.trim() || null,
          casino_site_url: data.casino_site_url.trim() || null,
          ...
          inline_image_count: data.generate_images ? data.inline_image_count : 0,
